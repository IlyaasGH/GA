...
<body>
    ...
    <header class="navbar" style="backdrop-filter: blur(10px); background: rgba(0, 0, 0, 0.5);">
        <div class="logo">🎮 Gaming Arena</div>
        <nav>
            <a href="#">Home</a>
    ...
    <!-- Lottie Section -->
    <section class="lotties">
        <div class="coconut" data-aos="fade-up">
            <script src="https://unpkg.com/@lottiefiles/dotlottie-wc@0.3.0/dist/dotlottie-wc.js" type="module"></script>
            <dotlottie-wc src="https://lottie.host/083a5cc7-ce4e-459a-8698-28133f07154f/itgf3LDRId.lottie" autoplay loop></dotlottie-wc>
            <script src="https://unpkg.com/@dotlottie/player-component@2.7.12/dist/dotlottie-player.mjs" type="module"></script>
            <dotlottie-player src="https://lottie.host/c0d5f093-7336-4e92-8073-9441de1e47b9/NasMrNUBgP.lottie" background="transparent" speed="1" style="width: 300px; height: 300px" loop autoplay></dotlottie-player>
        </div>
    </section>
